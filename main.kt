...
// 2 задание
fun task2() {
    // Создать список целых чисел и добавить в него 10 элементов.
    ...
    // Найти второй по величине элемент списка.
    ...
    // Преобразовать список чисел в множество (Set).
    val nmbrs = listOf(1, 2, 2, 3, 4, 4, 5)
    val nmbrsSet = numbersList.toSet()
}
